...
const PAGES: Record<string, ToolPageConfig> = {
  "reel-analyzer": {
    slug: "/reel-analyzer",
    title: "Reel Analyzer",
    metaTitle: "Free Reel Analyzer – Instagram Reel Analysis Tool | 5 Free Credits Monthly",
    metaDesc: "Free reel analyzer tool — get 5 free credits every month on signup. Analyze your Instagram reel performance instantly. Get viral score prediction, hook analysis, caption tips & engagement insights.",
    ...
    subtitle: "Paste your Instagram reel URL and get instant analysis with viral score prediction, hook strength detection, and engagement tips. 5 free credits every month.",
  ...
  "instagram-reel-analyzer": {
    ...
    metaTitle: "Free Instagram Reel Analyzer – Check Reel Viral Potential | 5 Free Credits Monthly",
    metaDesc: "Free Instagram reel analyzer — 5 free credits every month. Check your reel's viral potential, analyze engagement metrics, get hook score, caption tips & hashtag optimization.",
    ...
    subtitle: "The most comprehensive free Instagram reel analysis tool. Get 5 free credits every month — smart insights on hook strength, caption quality, and viral probability.",
  ...
  "reel-seo-optimizer": {
    ...
    metaTitle: "Free Reel SEO Optimizer – Optimize Instagram Reel for Search | 5 Free Credits Monthly",
    metaDesc: "Free reel SEO optimization tool — 5 free credits every month. Generate SEO-optimized titles, captions, and hashtags for Instagram reels. Improve discoverability free.",
    ...
    subtitle: "Generate SEO-optimized titles, captions, and hashtags for free. 5 free credits every month — help Instagram's algorithm push your reels to more people.",
  ...
  "reel-hashtag-generator": {
    ...
    metaDesc: "Free hashtag generator for Instagram reels — 5 free credits every month. AI finds trending, niche-specific hashtags to maximize your reel reach and engagement.",
    ...
    subtitle: "Generate the perfect hashtag mix for your Instagram reels for free. 5 free credits every month — smart analysis finds trending & niche-specific hashtags.",
  ...
  "reel-caption-generator": {
    ...
    metaDesc: "Free reel caption generator — 5 free credits every month. Generate engaging, SEO-optimized captions for Instagram reels with hooks, emotional triggers & CTAs.",
    ...
    subtitle: "Generate scroll-stopping captions for your reels for free. 5 free credits every month — captions with emotional hooks, trending keywords & CTAs.",
  ...
  "reel-title-generator": {
    ...
    metaDesc: "Free reel title generator — 5 free credits every month. AI creates clickable, keyword-rich titles that improve discoverability in Instagram search.",
    ...
    subtitle: "Generate attention-grabbing titles for your reels for free. 5 free credits every month — keyword-optimized titles that Instagram's search algorithm loves.",
  ...
  "reel-viral-checker": {
    ...
    metaTitle: "Free Reel Viral Checker – Check if Your Reel Can Go Viral | 5 Free Credits Monthly",
    metaDesc: "Free reel viral checker — 5 free credits every month. Check your Instagram reel's viral probability instantly. Get viral score & improvement tips before posting.",
    ...
    subtitle: "Predict your reel's viral probability for free before you post. 5 free credits every month — get viral score, identify weak spots & fix them.",
  ...
  "reel-engagement-calculator": {
    ...
    metaDesc: "Free reel engagement calculator — 5 free credits every month. Calculate your Instagram reel's engagement rate and compare against niche benchmarks for free.",
    ...
    subtitle: "Calculate your reel's engagement rate for free and compare against niche benchmarks. 5 free credits every month — understand which metrics matter most.",
